...
class TeamcityReporter {
    ...
    beforeItem(err, args) {
        ...
        console.log(`##teamcity[testStarted name='${this.escape(this.currItem.name)}' captureStandardOutput='true']`);
    }
    ...
    item(err, args) {
        ...
        console.log(`##teamcity[testFinished name='${this.escape(args.item.name)}' duration='${duration}']`);
    }
